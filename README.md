...
- Programming Languages: **JavaScript**, **TypeScript**, **Python**, **C#**, and **Java**.
- Frameworks/Libraries/Technology: **ReactJS**, **React Native**, **NodeJS**, **ExpressJS**, **TailwindCSS**, and **GraphQL**.
- Markup Languages: **HTML** and **LaTeX**.
- Style Sheet Languages: **CSS**.
- Databases: **PostgreSQL**, **MySQL**, **MongoDB**, and **Microsoft SQL Server**.
